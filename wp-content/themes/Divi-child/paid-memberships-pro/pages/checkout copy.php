...
<div class="signup_level2 min_height container">
...
<?php if ($pmpro_show_discount_code) { ?>
                        ...
                        <thead>
                            <tr>
                                <th>
                                    ...
                                    <span class="pmpro_thead-msg"><?php _e('Already have an account?', 'paid-memberships-pro'); ?> <a href="<?php echo get_the_permalink(28741); ?>"><?php _e('Log in here', 'paid-memberships-pro'); ?></a></span>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
    ...
    ?>
                                    <div id="displaygroupname">
                                        ...
                                        <input id="groupname" name="groupname" type="text"  class="input <?php echo pmpro_getClassForField("groupname"); ?>" size="30" value="<?php echo esc_attr($groupcode) ?>" maxlength="25" " />
    ...
    <?php endwhile; ?>
                                    ...
                                    <p>Your Sign Up price is <?php echo $pmpro_currency_symbol;
