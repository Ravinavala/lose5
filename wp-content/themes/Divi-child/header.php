    ...
    <body <?php body_class(); ?>>
        ...
        <div id="page-container"<?php echo $page_container_style; ?>>
            ...
            if (!empty($current_user->caps['pro_member'])):
                $classname = "pro_main_header";
            endif;
            ?>
            <header id="main-header" class="<?php echo $classname; ?>" data-height-onload="<?php echo esc_attr(et_get_option('menu_height', '66')); ?>">
                ...
                if (!empty($current_user->caps['pro_member'])):
                    if ($current_user->membership_levels):
                        echo '<div class="pro_user_logins">';
                        wp_nav_menu(array('menu' => 'promember_menu', 'container' => '', 'menu_class' => 'nav navbar-nav prouser_menu'));
                        echo '</div>';
                    endif;
                endif;
                ?>                                       
