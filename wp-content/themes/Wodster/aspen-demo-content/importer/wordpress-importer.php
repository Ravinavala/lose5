...
class WP_Import extends WP_Importer {
	...
	function import( $file ) {
		...
		if (defined('IMPORT_DEBUG') && IMPORT_DEBUG) {
			echo(current_time('r').' Importing taxonomies (categories, tags)...<br />');
			ob_flush(); flush();
		}
		...
		if (defined('IMPORT_DEBUG') && IMPORT_DEBUG) {
			echo(current_time('r').' Importing posts...<br />');
			ob_flush(); flush();
		}
		$this->process_posts();
		...
		if (defined('IMPORT_DEBUG') && IMPORT_DEBUG) {
			echo(current_time('r').' Updating database...<br />');
			ob_flush(); flush();
		}
...
<?php
	...
	function process_attachment( $post, $url ) {
		...
		if (defined('IMPORT_DEBUG') && IMPORT_DEBUG) {
			echo(current_time('r').' Processing attachment '.htmlspecialchars($url).'...<br />');
			ob_flush(); flush();
		}
...
function __aspen_importer_init() {
...
//add_action( 'admin_init', 'aspen_importer_init' );
