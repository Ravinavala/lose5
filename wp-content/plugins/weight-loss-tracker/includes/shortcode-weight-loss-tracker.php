...
function ws_ls_shortcode($user_defined_arguments) {
    ...
    if (($weight_data && count($weight_data) >= $shortcode_arguments['min-chart-points']) ||
        ...
        $html_output .= ws_ls_title(__('Track your weight loss progress', WE_LS_SLUG));
    ...
    if (false === empty($entry_id)) {
        ...
        $html_output .= ws_ls_display_weight_form(false, false, false, false, false, false, false, false, $redirect_url, $data, true, $shortcode_arguments['hide-photos']);
    } else {
