        ...
        <div id="pmpro_account">		
            ...
            <?php if (in_array('profile', $sections)) { ?>
                <div id="pmpro_account-profile" class="pmpro_box">	
                    ...
                    <div class="pmpro_actionlinks">
                        <a href="<?php the_permalink(28848); ?>" id="pmpro_account-edit-profile"><?php _e("Edit Profile", 'paid-memberships-pro'); ?></a>
                        <a href="<?php the_permalink(28848); ?>" id="pmpro_account-change-password"><?php _e('Change Password', 'paid-memberships-pro'); ?></a>
                    </div>
